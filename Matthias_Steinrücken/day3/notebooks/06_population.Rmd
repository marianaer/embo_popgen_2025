...
In this case it would be Beta(alpha,Beta)=Beta(40+1, 200-40+1).
So alpha=41, beta=161.
...
prob_vectors<-(seq(0,1,length=100)) # vector of probabilities from 0 to 1 (prior)

# to dbeta we pass the probability vectors (0 a 1) and alpha (41) and beta (161) 
...
plot(dbeta(prob_vectors,alpha,beta))


### Maximum a posteriori value would be 20/1000 (porque va de 0 a 1)
# Max posteriori value 0.2
